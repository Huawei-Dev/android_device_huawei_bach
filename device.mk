...
PRODUCT_COPY_FILES += \
    $(VENDOR_PATH)/audio/aanc_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/aanc_tuning_mixer.txt \
...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_PATH)/prebuilts/gps/izat.conf:$(TARGET_COPY_OUT_VENDOR)/etc/izat.conf \
    $(VENDOR_PATH)/prebuilts/gps/lowi.conf:$(TARGET_COPY_OUT_VENDOR)/etc/lowi.conf \
    $(VENDOR_PATH)/prebuilts/gps/sap.conf:$(TARGET_COPY_OUT_VENDOR)/etc/sap.conf \
    $(VENDOR_PATH)/prebuilts/gps/xtwifi.conf:$(TARGET_COPY_OUT_VENDOR)/etc/xtwifi.conf
